/*! Made by Oliver Beattie. Built 2015-06-24 */
...
e._parentURI=this,e):void 0!==b&&"string"!=typeof b?(this._fragmentURI=b,b._parentURI=b,this._parts.fragment=e+b.toString(),this.build(!d),this):("string"==typeof b&&(this._fragmentURI=void 0),c.call(this,b,d))},b.build=function(a){var b=d.call(this,a);return!1!==a&&this._parentURI&&this._parentURI.fragment(this),b},a}),function(){$(function(){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p;return d=[],a={},i=new google.maps.Map($("#map")[0],{zoom:10,center:new google.maps.LatLng(51.500358,-.125506),mapType:google.maps.MapTypeId.ROADMAP,disableDefaultUI:!0,mapTypeControl:!0,mapTypeControlOptions:{style:google.maps.MapTypeControlStyle.DROPDOWN_MENU}}),k=new google.maps.places.PlacesService(i),g=new google.maps.InfoWindow,f={mi:3963.1676,km:6378.1,ft:20925524.9,mt:6378100,"in":251106299,yd:6975174.98,fa:3487587.49,na:3443.89849,ch:317053.408,rd:1268213.63,fr:31705.3408},e=function(a){var b;b=new google.maps.Marker({map:i,position:a.geometry.location,icon:{path:"M 0,-24 6,-7 24,-7 10,4 15,21 0,11 -15,21 -10,4 -24,-7 -6,-7 z",fillColor:"#ffff00",fillOpacity:1,scale:.25,strokeColor:"#bd8d2c",strokeWeight:1}}),google.maps.event.addListener(b,"click",function(){k.getDetails(a,function(a,c){return c!==google.maps.places.PlacesServiceStatus.OK?void alert(c):(g.setContent(a.name),void g.open(i,b))})})},j=function(){return a===this&&(a={}),this.setMap(null)},l=function(a,b){var c,d,f,g,h;if(b===google.maps.places.PlacesServiceStatus.OK){for(h=[],c=d=0,g=a.length;g>=0?g>d:d>g;c=g>=0?++d:--d)f=a[c],h.push(e(a[c]));return h}},p=function(b){return null!=a&&Object.keys(a).length>0&&a.setOptions({fillColor:"#004de8"}),a=b,b.setOptions({fillColor:"red"})},b=function(a){return p(this)},c=function(a){var c,d,e,g;return e=$("#unitSelector"),g=$("option",e).eq(e[0].selectedIndex).val(),d=parseFloat(document.getElementById("radiusInput").value),d=d/f[g]*f.mt,c=new google.maps.Circle({center:a.latLng,clickable:!0,draggable:!1,editable:!1,fillColor:"#004de8",fillOpacity:.27,map:i,radius:d,strokeColor:"#004de8",strokeOpacity:.62,strokeWeight:1}),p(c),google.maps.event.addListener(c,"rightclick",j),google.maps.event.addListener(c,"click",b)},google.maps.event.addListener(i,"click",c),o=document.getElementById("searchInput"),$(o.form).on({submit:function(){return!1}}),n=new google.maps.places.SearchBox(o),google.maps.event.addListener(n,"places_changed",function(){var a;a=n.getPlaces()[0],null!=a&&(null!=a.geometry.viewport?(i.fitBounds(a.geometry.viewport),i.panToBounds(a.geometry.viewport)):i.setCenter(a.geometry.location))}),h=document.getElementById("keywordInput"),$(h.form).on({submit:function(){var b,c,d,e;return b=h.value,null!=a&&Object.keys(a).length>0&&(c=a.getCenter(),e=a.getRadius(),console.log(c),console.log(e),d={location:c,radius:e,keyword:b,rank:google.maps.places.RankBy.DISTANCE},k.radarSearch(d,l)),!1}}),m=document.getElementById("radiusInput"),$(m.form).on({submit:function(){return!1}}),$(window).on("hashchange",function(a){var b,c,d,e,f;return e=(new URI).fragment(!0).query(!0),c=i.getCenter(),b=[c.lat(),c.lng()],d=[b[0],b[1]],null!=e.lat&&(d[0]=parseFloat(e.lat)),null!=e.lng&&(d[1]=parseFloat(e.lng)),0===$.grep(d,isNaN).length&&i.setCenter({lat:d[0],lng:d[1]}),null!=e.z&&(f=parseInt(e.z,10),isNaN(f)||i.setZoom(f)),null!=e.r&&$("#radiusInput").val(e.r),null!=e.u?$("#unitSelector").val(e.u):void 0}).triggerHandler("hashchange")})}.call(this);
